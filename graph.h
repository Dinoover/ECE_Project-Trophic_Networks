...
class GraphInterface
{
    ...
    private :
        ...
        ///Barre des taches regroupant toutes les fonctions du programme
        grman::WidgetBox m_toolbar;

        //boutons des fonctions
        grman::WidgetButton m_button_add;
        grman::WidgetButton m_button_delete;
        grman::WidgetButton m_button_save;
        grman::WidgetButton m_button_load;
        grman::WidgetButton m_button_fco;
        grman::WidgetButton m_button_kco;
        grman::WidgetButton m_button_exit;

        //images représentenat les différentes fonctions
        grman::WidgetImage m_img_add;
        grman::WidgetImage m_img_delete;
        grman::WidgetImage m_img_save;
        grman::WidgetImage m_img_load;
        grman::WidgetImage m_img_fco;
        grman::WidgetImage m_img_kco;
        grman::WidgetImage m_img_exit;
